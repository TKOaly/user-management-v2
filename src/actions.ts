...
export const markUserAsPaidAction: Action<UpdatePaymentActionData> = 'markUserAsPaid'
export const modifyCreateUserFormDataAction: Action<{[key: string]: any}> = 'modifyCreateUserFormData'
export const createUserAction: Action<void> = 'createUser'
export const setUserMembershipPaymentFormStateAction: Action<UserMembershipPaymentFormState> = 'setUserMembershipPaymentFormState'
export const createUserMembershipPaymentAction: Action<void> = 'createUserMembershipPayment'
